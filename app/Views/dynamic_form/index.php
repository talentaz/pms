        ...
        <div class="title-button-group">
            <?php
                    if ($login_user->is_admin) {
                        echo modal_anchor(get_uri("dynamic_form/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_feed_back'), array("class" => "btn btn-default", "title" => app_lang('add_feed_back')));
                    }
                    ?>
            </div>
        </div>
