...
use Inventory\Models\Inventory_view_model;
use Inventory\Models\Inventory_add_model;
...
class Inventory extends BaseConfig {
    ...
    public function __construct() {
        ...
        $inventory_view_model = new Inventory_view_model();
        $this->settings = $inventory_view_model->get_all_inventory()->getResult();
